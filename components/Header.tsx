  ...
  return (
    <header className="sticky top-0 z-40 bg-[#0a0e27]/95 backdrop-blur border-b border-[#2d3748]">
      <div className="max-w-md mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {showMenu && (
          <div className="absolute top-full right-4 mt-2 bg-[#141829] border border-[#2d3748] rounded-lg shadow-xl w-48">
            <button className="w-full text-left px-4 py-2 hover:bg-[#1a1f3a] transition-colors text-sm text-[#a8aac5]">
              Profile
            </button>
            <button className="w-full text-left px-4 py-2 hover:bg-[#1a1f3a] transition-colors text-sm text-[#a8aac5] border-t border-[#2d3748]">
              Settings
            </button>
            <button className="w-full text-left px-4 py-2 hover:bg-[#1a1f3a] transition-colors text-sm text-[#a8aac5] border-t border-[#2d3748]">
              Logout
